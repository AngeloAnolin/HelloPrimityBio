...
.demo-3 .content {
	background: url(assets/image-cover.jpg) no-repeat 50% 20%;
...
.tabscontent__item:first-child .box {
	background-image: url(assets/image-tab1.jpg);
}

.tabscontent__item:nth-child(2) .box {
	background-image: url(assets/image-tab2.jpg);
}

.tabscontent__item:nth-child(3) .box {
	background-image: url(assets/image-tab3.jpg);
}
